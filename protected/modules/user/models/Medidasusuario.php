...
/**
 * This is the model class for table "{{medidasusuarios}}".
 *
 * The followings are the available columns in table '{{medidasusuarios}}':
 * @property integer $id
...
class Medidasusuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, fecha, id_zona, id_usuario, fecha_creacion, observaciones', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Medidasusuario the static model class
	 */
