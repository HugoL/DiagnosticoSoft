...
class AdminController extends Controller
{
		...
		if( isset($_POST['User']) ){			
			...
			if( $mirol < $profile->rol ){ //No se puede crear un usuario de rol igual o superior
				...
				if($model->validate()&&$profile->validate()) {
					...
					$message = 'Se ha registrado un nuevo usuario en DiagnosticoSoft. Para que pueda acceder a la plataforma se debe activar accediendo como administrador.';	
	...
	private function mailsend($to,$cco,$from,$subject,$message,$rutapdf=null){
        ...
        $mail->SetFrom($from, 'DiagnosticoSoft');
