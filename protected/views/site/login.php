...
<div class="page-header">
	<center>
	<h1><img src="<?php echo Yii::app()->baseUrl ?>/images/llave.png" class="img-rounded" alt="Acceso restringido">SiluSoft<small>acceso a usuarios registrados</small></h1></center>
</div>
